...
namespace APIAutomationSample.Features.Comments
{
    ...
    [NUnit.Framework.DescriptionAttribute("Posting a Comment")]
    public partial class PostingACommentFeature
    {
...
#line 1 "Posting a Comment.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Comments", "Posting a Comment", " In order to make sure I can interact with Posts via the JSONPlaceholder API\r\n As" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 8
 testRunner.Given("a Happy Path Comment.json request body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 9
